    ...
    <section class="probootstrap-cover overflow-hidden relative"  style="background-image: url('assets/images/bg_1.jpg');" data-stellar-background-ratio="0.5"  id="section-home">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md">
            <h2 class="heading mb-2 display-4 font-light probootstrap-animate">Selamat Datang Admin! <br> Toko Teman Mendaki</h2>
            <a style="display:block;" href="/tambahbarang" role="button" class="btn btn-primary p-3 mr-3 pl-5 pr-5 text-uppercase d-lg-inline d-md-inline d-sm-block d-block mb-3">Tambah Barang</a>
      ...
      <div class="container">
        <div class="row text-center mb-5 probootstrap-animate">
          <div class="col-md-12">
            ...
            <form action="/admintokosearch" method="get" class="probootstrap-form">
            ...
            <div class="media probootstrap-media d-flex align-items-stretch mb-4 probootstrap-animate">
              ...
              <div class="media-body">
                ...
                <p>{{ $b->detail }}</p>
                <p><a href="/{{ $b->id}}/deletebarang">Klik disini untuk menghapus barang</a></p>
              </div>
            </div>
            @endforeach
      </div>
